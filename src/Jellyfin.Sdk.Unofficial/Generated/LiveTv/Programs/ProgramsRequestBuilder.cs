...
using Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.Item;
using Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.Recommended;
...
using System;
namespace Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs
{
    /// <summary>
    ...
    public partial class ProgramsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.Recommended.RecommendedRequestBuilder Recommended
        {
            get => new global::Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.Recommended.RecommendedRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Gets an item from the Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.item collection</summary>
        /// <param name="position">Program id.</param>
        /// <returns>A <see cref="global::Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.Item.WithProgramItemRequestBuilder"/></returns>
        public global::Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.Item.WithProgramItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("programId", position);
                return new global::Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.Item.WithProgramItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.ProgramsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Jellyfin.Sdk.Unofficial.Generated.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.ProgramsRequestBuilder.ProgramsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Jellyfin.Sdk.Unofficial.Generated.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.ProgramsRequestBuilder.ProgramsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Jellyfin.Sdk.Unofficial.Generated.Models.BaseItemDtoQueryResult?> PostAsync(global::Jellyfin.Sdk.Unofficial.Generated.Models.GetProgramsDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Jellyfin.Sdk.Unofficial.Generated.Models.BaseItemDtoQueryResult> PostAsync(global::Jellyfin.Sdk.Unofficial.Generated.Models.GetProgramsDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.ProgramsRequestBuilder.ProgramsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.ProgramsRequestBuilder.ProgramsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Jellyfin.Sdk.Unofficial.Generated.Models.GetProgramsDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Jellyfin.Sdk.Unofficial.Generated.Models.GetProgramsDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.ProgramsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.ProgramsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Jellyfin.Sdk.Unofficial.Generated.LiveTv.Programs.ProgramsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets available live tv epgs.
        /// </summary>
