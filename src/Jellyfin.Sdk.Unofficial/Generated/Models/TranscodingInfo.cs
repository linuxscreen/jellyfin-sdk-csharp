...
#nullable restore
        ...
        public global::Jellyfin.Sdk.Unofficial.Generated.Models.TranscodingInfo_HardwareAccelerationType? HardwareAccelerationType { get; set; }
        ...
        public global::Jellyfin.Sdk.Unofficial.Generated.Models.TranscodingInfo_TranscodeReasons? TranscodeReasons { get; set; }
        /// <summary>Gets or sets the thread count used for encoding.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Jellyfin.Sdk.Unofficial.Generated.Models.TranscodingInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Jellyfin.Sdk.Unofficial.Generated.Models.TranscodingInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Jellyfin.Sdk.Unofficial.Generated.Models.TranscodingInfo();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "HardwareAccelerationType", n => { HardwareAccelerationType = n.GetEnumValue<global::Jellyfin.Sdk.Unofficial.Generated.Models.TranscodingInfo_HardwareAccelerationType>(); } },
                { "Height", n => { Height = n.GetIntValue(); } },
                { "IsAudioDirect", n => { IsAudioDirect = n.GetBoolValue(); } },
                { "IsVideoDirect", n => { IsVideoDirect = n.GetBoolValue(); } },
                { "TranscodeReasons", n => { TranscodeReasons = n.GetEnumValue<global::Jellyfin.Sdk.Unofficial.Generated.Models.TranscodingInfo_TranscodeReasons>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Jellyfin.Sdk.Unofficial.Generated.Models.TranscodingInfo_HardwareAccelerationType>("HardwareAccelerationType", HardwareAccelerationType);
            writer.WriteIntValue("Height", Height);
            writer.WriteBoolValue("IsAudioDirect", IsAudioDirect);
            writer.WriteBoolValue("IsVideoDirect", IsVideoDirect);
            writer.WriteEnumValue<global::Jellyfin.Sdk.Unofficial.Generated.Models.TranscodingInfo_TranscodeReasons>("TranscodeReasons", TranscodeReasons);
