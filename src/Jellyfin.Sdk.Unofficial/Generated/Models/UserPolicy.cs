...
#nullable enable
        public List<global::Jellyfin.Sdk.Unofficial.Generated.Models.AccessSchedule>? AccessSchedules { get; set; }
#nullable restore
#else
        public List<global::Jellyfin.Sdk.Unofficial.Generated.Models.AccessSchedule> AccessSchedules { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Jellyfin.Sdk.Unofficial.Generated.Models.UnratedItem?>? BlockUnratedItems { get; set; }
#nullable restore
#else
        public List<global::Jellyfin.Sdk.Unofficial.Generated.Models.UnratedItem?> BlockUnratedItems { get; set; }
#endif
...
#nullable restore
        ...
        public global::Jellyfin.Sdk.Unofficial.Generated.Models.UserPolicy_SyncPlayAccess? SyncPlayAccess { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Jellyfin.Sdk.Unofficial.Generated.Models.UserPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Jellyfin.Sdk.Unofficial.Generated.Models.UserPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Jellyfin.Sdk.Unofficial.Generated.Models.UserPolicy();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "AccessSchedules", n => { AccessSchedules = n.GetCollectionOfObjectValues<global::Jellyfin.Sdk.Unofficial.Generated.Models.AccessSchedule>(global::Jellyfin.Sdk.Unofficial.Generated.Models.AccessSchedule.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "BlockUnratedItems", n => { BlockUnratedItems = n.GetCollectionOfEnumValues<global::Jellyfin.Sdk.Unofficial.Generated.Models.UnratedItem>()?.AsList(); } },
                { "BlockedChannels", n => { BlockedChannels = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "BlockedMediaFolders", n => { BlockedMediaFolders = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                ...
                { "EnabledChannels", n => { EnabledChannels = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "EnabledDevices", n => { EnabledDevices = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "EnabledFolders", n => { EnabledFolders = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                ...
                { "SyncPlayAccess", n => { SyncPlayAccess = n.GetEnumValue<global::Jellyfin.Sdk.Unofficial.Generated.Models.UserPolicy_SyncPlayAccess>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Jellyfin.Sdk.Unofficial.Generated.Models.AccessSchedule>("AccessSchedules", AccessSchedules);
            ...
            writer.WriteCollectionOfPrimitiveValues<string>("BlockedChannels", BlockedChannels);
            writer.WriteCollectionOfPrimitiveValues<string>("BlockedMediaFolders", BlockedMediaFolders);
            writer.WriteCollectionOfPrimitiveValues<string>("BlockedTags", BlockedTags);
            writer.WriteCollectionOfEnumValues<global::Jellyfin.Sdk.Unofficial.Generated.Models.UnratedItem>("BlockUnratedItems", BlockUnratedItems);
            ...
            writer.WriteCollectionOfPrimitiveValues<string>("EnabledChannels", EnabledChannels);
            writer.WriteCollectionOfPrimitiveValues<string>("EnabledDevices", EnabledDevices);
            writer.WriteCollectionOfPrimitiveValues<string>("EnabledFolders", EnabledFolders);
            ...
            writer.WriteEnumValue<global::Jellyfin.Sdk.Unofficial.Generated.Models.UserPolicy_SyncPlayAccess>("SyncPlayAccess", SyncPlayAccess);
        }
    }
}
