...
namespace Jellyfin.Sdk.Unofficial.Generated.Videos.Item.Hls1.Item.WithSegmentIdWithContainer
{
    ...
    public partial class WithSegmentIdWithContainerRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithSegmentIdWithContainerRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{item%2Did}/hls1/{playlistId}/{segmentId}.{container}?actualSegmentLengthTicks={actualSegmentLengthTicks}&runtimeTicks={runtimeTicks}{&allowAudioStreamCopy*,allowVideoStreamCopy*,alwaysBurnInSubtitleWhenTranscoding*,audioBitRate*,audioChannels*,audioCodec*,audioSampleRate*,audioStreamIndex*,breakOnNonKeyFrames*,context*,copyTimestamps*,cpuCoreLimit*,deInterlace*,deviceId*,deviceProfileId*,enableAudioVbrEncoding*,enableAutoStreamCopy*,enableMpegtsM2TsMode*,framerate*,height*,level*,liveStreamId*,maxAudioBitDepth*,maxAudioChannels*,maxFramerate*,maxHeight*,maxRefFrames*,maxVideoBitDepth*,maxWidth*,mediaSourceId*,minSegments*,params*,playSessionId*,profile*,requireAvc*,requireNonAnamorphic*,segmentContainer*,segmentLength*,startTimeTicks*,static*,streamOptions*,subtitleCodec*,subtitleMethod*,subtitleStreamIndex*,tag*,transcodeReasons*,transcodingMaxAudioChannels*,videoBitRate*,videoCodec*,videoStreamIndex*,width*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.Hls1.Item.WithSegmentIdWithContainer.WithSegmentIdWithContainerRequestBuilder.WithSegmentIdWithContainerRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.Hls1.Item.WithSegmentIdWithContainer.WithSegmentIdWithContainerRequestBuilder.WithSegmentIdWithContainerRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.Hls1.Item.WithSegmentIdWithContainer.WithSegmentIdWithContainerRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.Hls1.Item.WithSegmentIdWithContainer.WithSegmentIdWithContainerRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.Hls1.Item.WithSegmentIdWithContainer.WithSegmentIdWithContainerRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets a video stream using HTTP live streaming.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithSegmentIdWithContainerRequestBuilderGetQueryParameters 
        {
...
#nullable restore
            ...
            public global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.Hls1.Item.WithSegmentIdWithContainer.EncodingContext? Context { get; set; }
...
#nullable restore
            ...
            public string SegmentContainer { get; set; }
#endif
            /// <summary>The desired segment length.</summary>
...
#nullable restore
            ...
            public global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.Hls1.Item.WithSegmentIdWithContainer.SubtitleDeliveryMethod? SubtitleMethod { get; set; }
