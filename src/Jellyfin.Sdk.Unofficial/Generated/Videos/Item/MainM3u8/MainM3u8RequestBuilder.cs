...
namespace Jellyfin.Sdk.Unofficial.Generated.Videos.Item.MainM3u8
{
    ...
    public partial class MainM3u8RequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MainM3u8RequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{item%2Did}/main.m3u8{?allowAudioStreamCopy*,allowVideoStreamCopy*,alwaysBurnInSubtitleWhenTranscoding*,audioBitRate*,audioChannels*,audioCodec*,audioSampleRate*,audioStreamIndex*,breakOnNonKeyFrames*,context*,copyTimestamps*,cpuCoreLimit*,deInterlace*,deviceId*,deviceProfileId*,enableAudioVbrEncoding*,enableAutoStreamCopy*,enableMpegtsM2TsMode*,framerate*,height*,level*,liveStreamId*,maxAudioBitDepth*,maxAudioChannels*,maxFramerate*,maxHeight*,maxRefFrames*,maxVideoBitDepth*,maxWidth*,mediaSourceId*,minSegments*,params*,playSessionId*,profile*,requireAvc*,requireNonAnamorphic*,segmentContainer*,segmentLength*,startTimeTicks*,static*,streamOptions*,subtitleCodec*,subtitleMethod*,subtitleStreamIndex*,tag*,transcodeReasons*,transcodingMaxAudioChannels*,videoBitRate*,videoCodec*,videoStreamIndex*,width*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.MainM3u8.MainM3u8RequestBuilder.MainM3u8RequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.MainM3u8.MainM3u8RequestBuilder.MainM3u8RequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.MainM3u8.MainM3u8RequestBuilder.MainM3u8RequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.MainM3u8.MainM3u8RequestBuilder.MainM3u8RequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.MainM3u8.MainM3u8RequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.MainM3u8.MainM3u8RequestBuilder WithUrl(string rawUrl)
        {
            return new global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.MainM3u8.MainM3u8RequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets a video stream using HTTP live streaming.
        /// </summary>
...
#nullable restore
            ...
            public global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.MainM3u8.EncodingContext? Context { get; set; }
...
#nullable restore
            ...
            public global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.MainM3u8.SubtitleDeliveryMethod? SubtitleMethod { get; set; }
