...
namespace Jellyfin.Sdk.Unofficial.Generated.Videos.Item.LiveM3u8
{
    ...
    public partial class LiveM3u8RequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LiveM3u8RequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{item%2Did}/live.m3u8{?allowAudioStreamCopy*,allowVideoStreamCopy*,alwaysBurnInSubtitleWhenTranscoding*,audioBitRate*,audioChannels*,audioCodec*,audioSampleRate*,audioStreamIndex*,breakOnNonKeyFrames*,container*,context*,copyTimestamps*,cpuCoreLimit*,deInterlace*,deviceId*,deviceProfileId*,enableAudioVbrEncoding*,enableAutoStreamCopy*,enableMpegtsM2TsMode*,enableSubtitlesInManifest*,framerate*,height*,level*,liveStreamId*,maxAudioBitDepth*,maxAudioChannels*,maxFramerate*,maxHeight*,maxRefFrames*,maxVideoBitDepth*,maxWidth*,mediaSourceId*,minSegments*,params*,playSessionId*,profile*,requireAvc*,requireNonAnamorphic*,segmentContainer*,segmentLength*,startTimeTicks*,static*,streamOptions*,subtitleCodec*,subtitleMethod*,subtitleStreamIndex*,tag*,transcodeReasons*,transcodingMaxAudioChannels*,videoBitRate*,videoCodec*,videoStreamIndex*,width*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.LiveM3u8.LiveM3u8RequestBuilder.LiveM3u8RequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.LiveM3u8.LiveM3u8RequestBuilder.LiveM3u8RequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.LiveM3u8.LiveM3u8RequestBuilder.LiveM3u8RequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.LiveM3u8.LiveM3u8RequestBuilder.LiveM3u8RequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.LiveM3u8.LiveM3u8RequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.LiveM3u8.LiveM3u8RequestBuilder WithUrl(string rawUrl)
        {
            return new global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.LiveM3u8.LiveM3u8RequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets a hls live stream.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class LiveM3u8RequestBuilderGetQueryParameters 
        {
...
#nullable restore
            ...
            public global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.LiveM3u8.EncodingContext? Context { get; set; }
...
#nullable restore
            ...
            /// <summary>Optional. Whether to enable subtitles in the manifest.</summary>
            [QueryParameter("enableSubtitlesInManifest")]
...
#nullable restore
            ...
            /// <summary>Optional. The max height.</summary>
            ...
            /// <summary>Optional. The max width.</summary>
...
#nullable restore
            ...
            public global::Jellyfin.Sdk.Unofficial.Generated.Videos.Item.LiveM3u8.SubtitleDeliveryMethod? SubtitleMethod { get; set; }
