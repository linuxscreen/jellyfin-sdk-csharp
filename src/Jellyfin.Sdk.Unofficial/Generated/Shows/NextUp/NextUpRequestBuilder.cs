...
using System;
namespace Jellyfin.Sdk.Unofficial.Generated.Shows.NextUp
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Jellyfin.Sdk.Unofficial.Generated.Shows.NextUp.NextUpRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Jellyfin.Sdk.Unofficial.Generated.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Shows.NextUp.NextUpRequestBuilder.NextUpRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Jellyfin.Sdk.Unofficial.Generated.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Shows.NextUp.NextUpRequestBuilder.NextUpRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Shows.NextUp.NextUpRequestBuilder.NextUpRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Sdk.Unofficial.Generated.Shows.NextUp.NextUpRequestBuilder.NextUpRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Jellyfin.Sdk.Unofficial.Generated.Shows.NextUp.NextUpRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Jellyfin.Sdk.Unofficial.Generated.Shows.NextUp.NextUpRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Jellyfin.Sdk.Unofficial.Generated.Shows.NextUp.NextUpRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets a list of next up episodes.
        /// </summary>
